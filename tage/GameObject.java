...
public class GameObject
{
	...
	*/
	...
	/** Rotates the GameObject around the worlds upward-facing axis by the specified angle. */
	public void globalYaw(float angle) {
		Matrix4f globalRot = new Matrix4f().rotation(angle, 0, 1, 0);
		Matrix4f newRot = globalRot.mul(this.getLocalRotation());
